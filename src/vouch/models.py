...
class Visibility(StrEnum):
    PRIVATE = "private"  # only the authoring agent
    PROJECT = "project"  # anyone in the same project
    TEAM = "team"  # any registered team member
...
class Source(BaseModel):
    ...
    # Richer scope tuple — overrides `scope` when set.
